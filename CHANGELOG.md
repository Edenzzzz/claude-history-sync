...
- Abort Codex uploads with a visible error when a rollout's retained compacted tail does not match its `.pretrim.bak`; backups are never modified and automatic Codex trimming remains disabled.
